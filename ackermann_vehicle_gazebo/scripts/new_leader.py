...
rospy.init_node('Point_to_Point_Control', anonymous=True) 
...
def callback(data):
  ...
  msg = data
  pos_msg.position.x = round(msg.pose.pose.position.x, 4)		
  pos_msg.position.y = round(msg.pose.pose.position.y, 4)		
  pos_msg.position.z = round(msg.pose.pose.position.z, 4)		
  pos_msg.orientation.x = round(msg.pose.pose.orientation.x, 4)	
  pos_msg.orientation.y = round(msg.pose.pose.orientation.y, 4)	
  pos_msg.orientation.z = round(msg.pose.pose.orientation.z, 4)	
  pos_msg.orientation.w = round(msg.pose.pose.orientation.w, 4)	
...
def callback_Init(data):
  ...
  msg = data
  pos_msg_0.position.x = round(msg.pose.pose.position.x, 4)		
  pos_msg_0.position.y = round(msg.pose.pose.position.y, 4)		
  pos_msg_0.position.z = round(msg.pose.pose.position.z, 4)		
  pos_msg_0.orientation.x = round(msg.pose.pose.orientation.x, 4)	
  pos_msg_0.orientation.y = round(msg.pose.pose.orientation.y, 4)	
  pos_msg_0.orientation.z = round(msg.pose.pose.orientation.z, 4)	
  pos_msg_0.orientation.w = round(msg.pose.pose.orientation.w, 4)	
  [yaw, pitch, roll] = quaternion_to_euler(pos_msg.orientation.x, pos_msg.orientation.y, pos_msg.orientation.z, pos_msg.orientation.w)
...
sub1 = rospy.Subscriber('/odom', Odometry, callback_Init) 
