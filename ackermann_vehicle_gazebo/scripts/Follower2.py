...
sub1 = rospy.Subscriber("robot1/odom", Odometry, callback_Init) 
def callback(data):
...
sub2 = rospy.Subscriber("robot1/odom", Odometry, callback) 
def callforward_Init(data):
  ...
  print("forward")
sub3 = rospy.Subscriber("robot2/odom", Odometry, callforward_Init) 
...
sub4 = rospy.Subscriber("robot2/odom", Odometry, callforward)
